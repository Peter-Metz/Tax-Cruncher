...
def TaxInc(c00100, standard, c04470, c04600, MARS, e00900, e26270,
    ...
    if PT_qbid_taxinc_thd[MARS-1] > 1:
...
def GainsTax(e00650, c01000, c23650, p23250, e01100, e58990, e00200,
    ...
    if hasqdivltcg == 1:
        ...
        total_gain = dwks20 + dwks28 + dwks31
        hi_base = max(0., total_gain - CG_brk3[MARS - 1])
...
def CDCC_new(CDCC_new_c, CDCC_new_rt, CDCC_new_ps, CDCC_new_pe, CDCC_new_prt, cdcc_new,
            MARS, f2441, e32800, earned_s, earned_p, c05800, e07300, c00100, c07180):
    """
    ...
    if positiveagi < cdcc_min:
        ...
        cdcc_new = max(0., cdcc_new - CDCC_new_prt * (positiveagi - cdcc_min))
